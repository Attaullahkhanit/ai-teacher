  ...
  const faqpagecarditems1 = [
    {
      ...
      paratext: 'Teaching Copilot AI platform is suitable for all age ranges, as it caters to the unique needs of educators. From primary to secondary school, it provides tools and resources for engaging learning experiences and better outcomes. Our commitment is to make AI accessible and user-friendly for all teachers.'
    }
  ]
  ...
  const feqpageCarditems2 = [
    {
      ...
      paratext: 'AI is powerfull tools that can benefit teachers in all subjects. In English, it can be used automated grading and writing prompts. in math, it can generate interative quizzes and personlized learning paths. In science. it can aid and data analysis and experiment design. The possibilities are endless. and by hamessing the power of AI. teacher can provide more effective and engaging learning experiences for their students.'
    }
  ]
  const feqpageCarditems3 = [
    {
      title: 'What can i create with Teaching Copilot?',
      paratext: 'Teaching Copilot is AI platform provides a wide range of tools for teachers, including lesson plan creation, quiz building, educational handout design, and report writing. Our platform is designed to help teachers save time and streamline their workload while providing high-quality resources for their students learning.'
    }
  ]
  const feqpageCarditems4 = [
    {
      title: 'Is it worth upgrading to the pro plan?',
      paratext: 'By signing up for the Pro Plan you ll get full access to Teaching Copilot is powerful AI platform, including premium tools, the latest features and Increased storage. This will enable you to store more files and create even more engaging lesson plans and quizzes. By choosing the Pro Plan, you will also be supporting other teachers and the growth of our platform.'
    }
  ]
  ...
  return (
    <>
      ...
      <div className='container'>
        <div className='pt-5'>
          <h5 >At AI Online Teacher, we are proud to say that our AI platform is developed</h5>
        </div>
        ...
        <div className='row py-1'>
          <div className='col-lg-5 col-md-12 col-sm-12'>
            <div className='card px-lg-5 pt-lg-5 pb-lg-0 px-sm-3 my-3 border-0'>
              ...
              <p>
                You are doing an amazing job , and we appreciate all the hard work you're
                putting in to educate our future generations.
                If you ever need any support or guidance, please don't hesitate to
                reach out to us. We are here to empower and assist you on your journey
                as an educator. Keep up the great work!
              </p>
            </div>
          </div>
